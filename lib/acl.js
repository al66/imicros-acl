...
module.exports = {
    ...
    actions: {
        ...
        grantAccess: {
            visibility: "public",
            acl: "before",
            async handler({ meta: { acl: { ownerId = null }, service: { serviceId = null }}}) {
        ...
        exchangeToken: {
            ...
            async handler({ params, meta: { service: { serviceId = null }}}) {
                try {
                    ...
                    //let options = { issuer: ..., audience: ... };
                    let options = { issuer: this.jwtIssuer, subject: grant.ownerId };
                    return { token: jwt.sign(payload, this.JWT_SECRET,options) };
                } catch (err) {
